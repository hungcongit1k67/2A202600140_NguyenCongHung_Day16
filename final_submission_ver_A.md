...
> **Observed gap (Khoảng trống đã quan sát)**: Các shop online nhỏ gặp khó khăn trong việc quản lý tin nhắn khách hàng vào giờ cao điểm. Họ không thể trả lời kịp, dẫn đến mất đơn hàng.  
> **Founding belief (niềm tin khởi đầu)**: Nếu AI có thể tự động hóa việc trả lời tin nhắn khách hàng, chủ shop có thể tăng hiệu quả bán hàng và giữ chân khách hàng, đặc biệt là vào giờ cao điểm mà họ không thể trực chat liên tục.
...
- **Why underserved**: Các hệ thống trả lời tự động hiện tại không đủ linh hoạt và thông minh để xử lý cuộc trò chuyện trong ngữ cảnh bán hàng.
...
2. Onboarding for new stores becomes faster.
3. Customer satisfaction improves due to faster response times.

Why competitors cannot easily replicate this:  
> Competitors cannot replicate our domain-specific focus and learning loop that continuously improves AI performance in a specialized market.
...
|---|---|---|---|
| TAM | $1B–$2B/year | All small and medium-sized e-commerce stores globally. | High |
| SAM | $50M–$100M/year | Focus on online shops in Southeast Asia (Shopee, Facebook, TikTok). | Medium |
| SOM | $5M–$10M | Target market in 12–24 months, starting with 1,000 stores. | High |

**Top 3 unknowns requiring further research:**
1. Market growth rate in Southeast Asia's e-commerce sector.
2. Cost of customer acquisition for small shops.
3. AI's potential to handle specific product categories (e.g., fashion vs. electronics).

**Judgment:**
- [ ] Worth pursuing now
- [x] Worth pursuing but not now (need to validate AI capabilities and cost of customer acquisition first)
...
**What we are:**  
> An AI-powered chatbot specifically designed for small online shops to automate customer responses and reduce manual effort.

**What we are not / not yet:**  
> We are not a generic chatbot platform for all industries, nor are we currently equipped to handle highly specialized customer queries outside the retail domain.

---

## 8. Self-assessment before Day 17
Trong 6 mắt xích (Idea Customer Need Strategy Moat Market Size), mắt xích nào đang yếu nhất ở nhóm bạn?  
> Mắt xích "Need" cần thêm nghiên cứu để làm rõ các "pain moments" của khách hàng trong ngành bán lẻ trực tuyến.

Open questions chúng tôi muốn khám phá thêm ở Day 17:
1. Cách tối ưu chi phí acquisition cho khách hàng.
2. Làm thế nào để nâng cao tính chính xác của AI trong các kịch bản phức tạp hơn?
3. Cần thêm thông tin về việc triển khai AI trong các ngành bán lẻ khác.
